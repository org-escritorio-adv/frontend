  ...
  return (
    <>
      ...
      {(notifOpen || profileOpen) && (
        <div className="fixed inset-0 z-[55]" onClick={closeAll} aria-hidden="true" />
      )}
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className={`text-xs leading-tight mb-0.5 ${n.unread ? 'font-semibold text-[#1A2B3C]' : 'font-medium text-slate-700'}`}
                  >
                    {n.title}
                  </p>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-3.5 rounded-xl mb-0.5 transition-all ${
                  active ? 'bg-[#1A2B3C] text-white shadow-sm' : 'text-slate-700 hover:bg-slate-100'
                }`}
              >
                <div

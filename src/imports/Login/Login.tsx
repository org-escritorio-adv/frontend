...
function Heading1() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[30px] left-1/2 not-italic text-[#1a2b3c] text-[20px] text-center top-[calc(50%-15px)] w-[344px]">Bem vindo a Área do Advogado</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[172px] not-italic text-[#45556c] text-[16px] text-center top-[-1px] w-[344px]">Insira suas credenciais de Login</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-[#1a2b3c] h-[32px] left-[122.5px] rounded-[10px] top-[275px] w-[119px]" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[59px] not-italic text-[16px] text-center text-white top-[4px] w-[126px]">ENTRAR</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[24px] left-[9.5px] top-[321px] w-[344px]" data-name="Paragraph">
      <div className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[172px] not-italic text-[#45556c] text-[16px] text-center top-[-1px] w-[344px]">
        <p className="leading-[24px] mb-0">ou</p>
        <p className="decoration-solid leading-[24px] underline">recupere sua senha</p>
      </div>
    </div>
  );
}
...
function Dashboard() {
  return (
    <div className="absolute h-[381px] left-[594px] top-[297px] w-[363px]" data-name="Dashboard">
      <Container2 />
      <Button />
      <div className="absolute h-[43px] left-[9.5px] top-[123px] w-[344px]">
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[31.5px] not-italic text-[#45556c] text-[16px] top-[132px] w-[322px]">E-mail</p>
      <div className="absolute h-[43px] left-[9.5px] top-[199px] w-[344px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 344 43">
          <path d={svgPaths.p23cd0870} fill="var(--fill-0, #D9D9D9)" id="Rectangle 2" />
        </svg>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[31.5px] not-italic text-[#45556c] text-[16px] top-[208px] w-[322px]">Senha</p>
      <Paragraph1 />
    </div>
  );
}
        ...
        <div className="absolute h-[162px] left-[639px] top-[87px] w-[273px]" data-name="logo 1">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
            <div className="absolute inset-0 overflow-hidden">
              <img alt="" className="absolute h-[211.2%] left-[-185.6%] max-w-none top-[-45.21%] w-[285.52%]" src={imgLogin} />
            </div>
            <div className="absolute inset-0 overflow-hidden">
              <img alt="" className="absolute h-[211.2%] left-[-185.6%] max-w-none top-[-45.21%] w-[285.52%]" src={imgLogin} />
            </div>
...
function App() {
  return (
    <div className="bg-[#f8fafc] content-stretch flex h-[913px] items-start relative shrink-0 w-full" data-name="App">
      <Container />
    </div>
  );
}
...
export default function Login() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Login">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">

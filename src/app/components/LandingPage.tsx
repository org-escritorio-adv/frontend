...
import {
  ...
  Target, Eye, Sparkles, Send, Calendar, ArrowRight,
      ...
      <div className="max-w-[1216px] mx-auto px-8 h-[72px] flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-3">
          ...
          <div style={montserrat}>
            <p className="text-[#f5f5f5] text-[14px] leading-none" style={{ fontWeight: 600 }}>Barcelos &amp; Takaki</p>
            <p className="text-[#c5a059] text-[11px] leading-none mt-0.5" style={{ fontWeight: 400 }}>Advocacia</p>
          </div>
        </a>
...
function HeroSection() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(155.129deg, #121212 0%, #141414 12.5%, #161616 25%, #181818 37.5%, #1a1a1a 50%, #181818 62.5%, #161616 75%, #141414 87.5%, #121212 100%)",
      }}
    >
      {/* Decorative blurs */}
      ...
      <div className="relative max-w-[1216px] mx-auto px-8 pt-28 pb-20 w-full">
        <div className="max-w-[660px]">
          ...
          {/* Heading */}
          <h1 className="text-[#f5f5f5] mb-2 leading-[1.1]" style={{ ...ebGaramond, fontSize: "clamp(48px,5vw,72px)", fontWeight: 500 }}>
            Defendemos o que<br />mais importa
          </h1>
          <h1 className="mb-8 leading-[1.1]" style={{ ...ebGaramond, fontSize: "clamp(48px,5vw,72px)", fontWeight: 500, fontStyle: "italic", color: "#c5a059" }}>
            para você
          </h1>

          {/* Subtitle */}
          <p className="text-[#f5f5f5] text-[18px] leading-[1.8] mb-10 max-w-[562px] text-justify" style={montserrat}>
            Soluções jurídicas estratégicas com rigor técnico, ética inabalável e compromisso com os resultados do cliente.
          </p>
    ...
    <section id="servicos" className="bg-[#f5f5f5] py-24 relative overflow-hidden">
      <div className="max-w-[1216px] mx-auto px-8">
        ...
        <div className="text-center mb-5">
          <h2 className="text-[#121212] text-[48px] leading-[48px]" style={{ ...playfair, fontWeight: 500 }}>
            Nossos Serviços Jurídicos
          </h2>
        </div>
        <p className="text-[#4a5565] text-[18px] leading-[28px] text-center max-w-[672px] mx-auto mb-16" style={montserrat}>
          O escritório atua de forma abrangente nas principais áreas do Direito, com forte vocação para o contencioso estratégico e orientação preventiva voltada à proteção dos interesses do cliente.
        </p>
            ...
            return (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <h3 className="text-[#1b2539] text-[24px] leading-[32px] mb-4" style={{ ...playfair, fontWeight: 500 }}>
                    {area.title}
                  </h3>
...
function AnalisarCasoSection() {
  ...
  const inputCls = "w-full h-[50px] bg-white rounded-[10px] border border-[#d1d5dc] px-4 text-[16px] text-[#121212] placeholder-[rgba(10,10,10,0.4)] outline-none focus:border-[#c5a059] focus:ring-1 focus:ring-[#c5a059] transition";
    ...
    <section id="analisar-caso" className="bg-white py-24">
      <div className="max-w-[1216px] mx-auto px-8">
        ...
        <div className="text-center mb-14">
          <h2 className="text-[#121212] text-[48px] leading-[48px] mb-4" style={{ ...playfair, fontWeight: 500 }}>
            Envie seu Caso para Análise
          </h2>
          <p className="text-[#4a5565] text-[18px] leading-[28px] max-w-[600px] mx-auto" style={montserrat}>
            Preencha o formulário abaixo e nossa equipe jurídica analisará seu caso e entrará em contato em até 24 horas.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-[960px] mx-auto">
          ...
          <div>
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full gap-4 py-12">
                ...
                <h3 className="text-[#1b2539] text-[24px]" style={{ ...playfair, fontWeight: 500 }}>Caso enviado!</h3>
                <p className="text-[#4a5565] text-[16px] text-center leading-relaxed" style={montserrat}>
                  Nossa equipe analisará seu caso e retornará o contato em até 24 horas.
                </p>
                <button onClick={() => setSubmitted(false)}
                  className="mt-4 text-[#c5a059] text-[14px] underline" style={montserrat}>
                  Enviar outro caso
                </button>
              </div>
            ) : (
              <form onSubmit={handle} className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Nome Completo *</label>
                  <input required className={inputCls} placeholder="João Silva"
                    value={form.nome} onChange={(e) => setForm({ ...form, nome: e.target.value })} />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2">
                    <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>E-mail *</label>
                    <input required type="email" className={inputCls} placeholder="joao@email.com"
                      value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Telefone *</label>
                    <input required className={inputCls} placeholder="(61) 9XXXX-XXXX"
                      value={form.telefone} onChange={(e) => setForm({ ...form, telefone: e.target.value })} />
                  </div>
                </div>

                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Área do Direito *</label>
                  <select required
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Descreva brevemente seu caso *</label>
          ...
          <div className="bg-[#1b2539] rounded-[10px] p-10 flex flex-col justify-between shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
            <div>
              ...
              <h3 className="text-[#f5f5f5] text-[28px] leading-tight mb-4" style={{ ...playfair, fontWeight: 500 }}>
                Análise gratuita<br />do seu caso
              </h3>
              <p className="text-[#f5f5f5] text-[16px] leading-relaxed opacity-80 mb-8" style={montserrat}>
                Nossa equipe de advogados especializados avaliará seu caso sem compromisso e indicará o melhor caminho jurídico.
              </p>
              <ul className="flex flex-col gap-4">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3">
                    ...
                    <span className="text-[#f5f5f5] text-[15px] opacity-80" style={montserrat}>{item}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="relative">
            <div
              ...
              style={{ background: "linear-gradient(128.66deg, #121212 0%, #151515 22%, #1a1a1a 55%, #242424 88%, #2a2a2a 100%)" }}
            >
              {/* Decorative borders */}
              ...
              <div className="absolute bottom-8 right-8 bg-[#c5a059] rounded-[10px] px-6 py-4 shadow-[0px_20px_25px_0px_rgba(0,0,0,0.2)]">
                <p className="text-[#121212] text-[36px] leading-none" style={{ ...playfair, fontWeight: 400 }}>10+</p>
                <p className="text-[#121212] text-[14px]" style={montserrat}>Anos de Excelência</p>
              </div>
            </div>
          </div>
          ...
          {/* Right – mission text */}
          <div>
            <h2 className="mb-4 text-[48px] leading-[48px]" style={{ ...playfair, fontWeight: 500 }}>
            ...
            <p className="text-[#f5f5f5] text-[18px] leading-[29px] text-justify mb-6" style={montserrat}>
              Barcelos &amp; Takaki foi fundado com base no princípio de que uma atuação jurídica de excelência vai além do domínio técnico do Direito. Ela exige visão estratégica, capacidade analítica e compromisso absoluto com os interesses de cada cliente.
            </p>
            <p className="text-[#f5f5f5] text-[18px] leading-[26px] text-justify mb-10" style={montserrat}>
              Nosso escritório atua de forma personalizada, atendendo pessoas físicas e jurídicas em diferentes áreas do Direito. Aliamos solidez jurídica tradicional a uma abordagem moderna orientada a resultados.
            </p>
            ...
            <div className="flex flex-col gap-5">
              {missionValues.map((v) => {
                const Icon = v.Icon;
                return (
                  <div key={v.id} className="bg-[#f5f5f5] rounded-[10px] px-6 py-5 flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="text-[#1b2539] text-[20px] leading-[28px] mb-1" style={{ ...playfair, fontWeight: 500 }}>
                        {v.title}
                      </h4>
                      <p className="text-[#4a5565] text-[15px] leading-[26px] text-justify" style={montserrat}>{v.text}</p>
                    </div>
                  </div>
                );
              })}
  ...
  return (
    <section id="equipe" className="bg-[#f5f5f5] py-24">
      <div className="max-w-[1216px] mx-auto px-8">
        ...
        <p className="text-[#4a5565] text-[18px] leading-[28px] text-center max-w-[616px] mx-auto mb-16" style={montserrat}>
          Profissionais qualificados e comprometidos em oferecer atendimento jurídico estratégico, ético e eficiente para cada cliente.
        </p>
          ...
          {teamMembers.map((m) => (
            ...
            >
              ...
              <div className="p-6 relative">
                <h3 className="text-[#212e46] text-[24px] leading-[32px] mb-1" style={{ ...playfair, fontWeight: 500 }}>
                  {m.name}
                </h3>
                <p className="text-[#c5a059] text-[16px] leading-[24px] mb-1" style={montserrat}>{m.role}</p>
                <p className="text-[#4a5565] text-[14px] leading-[20px]" style={montserrat}>{m.specialty}</p>

                {/* OAB divider */}
                <div className="border-b border-[#e5e7eb] mt-3 mb-3 pb-3">
                  <p className="text-[#6a7282] text-[12px]" style={montserrat}>{m.oab}</p>
                </div>

                {/* Bio */}
                <p className="text-[#4a5565] text-[12px] leading-[22px] mb-4" style={montserrat}>{m.bio}</p>

                {/* Contact */}
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2 text-[#c5a059] text-[12px]" style={montserrat}>
        ...
        <div className="flex flex-wrap justify-center gap-16">
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col items-center text-center w-[220px]">
              ...
              <p className="text-[#c5a059] text-[48px] leading-[48px]" style={{ ...playfair, fontWeight: 400 }}>
                {s.num}
              </p>
              <p className="text-[#f5f5f5] text-[18px] leading-[28px] mt-1" style={montserrat}>{s.label}</p>
              <p className="text-[#f5f5f5] text-[14px] leading-[20px] opacity-70 mt-1" style={montserrat}>{s.sub}</p>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <section id="contato" className="bg-[#f5f5f5] py-24">
      <div className="max-w-[1216px] mx-auto px-8">
        ...
        <p className="text-[#4a5565] text-[18px] leading-[28px] text-center max-w-[625px] mx-auto mb-14" style={montserrat}>
          Pronto para discutir sua situação jurídica? Entre em contato conosco e agende um atendimento personalizado.
        </p>
        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div>
              <h3 className="text-[#f5f5f5] text-[22px] leading-tight" style={{ ...playfair, fontWeight: 500 }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
            ...
            <a href="https://wa.me/556198226-5931" target="_blank" rel="noreferrer"
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          {/* Message form */}
          <div>
            <h3 className="text-[#121212] text-[24px] leading-[32px] mb-6" style={{ ...playfair, fontWeight: 500 }}>
            ...
            {msgSent ? (
              <div className="flex flex-col items-center gap-4 py-10">
                ...
                <p className="text-[#1b2539] text-[18px]" style={{ ...playfair, fontWeight: 500 }}>Mensagem enviada!</p>
                <p className="text-[#4a5565] text-[15px] text-center" style={montserrat}>
                  Retornaremos o contato em até 24 horas.
                </p>
                <button onClick={() => setMsgSent(false)} className="text-[#c5a059] text-[14px] underline" style={montserrat}>
              ...
              <form onSubmit={handleMsg} className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Nome Completo *</label>
                  <input required className={inputCls} placeholder="João Silva"
                    value={msgForm.nome} onChange={(e) => setMsgForm({ ...msgForm, nome: e.target.value })} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>E-mail *</label>
                  <input required type="email" className={inputCls} placeholder="joao.silva@email.com"
                    value={msgForm.email} onChange={(e) => setMsgForm({ ...msgForm, email: e.target.value })} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Número de Telefone *</label>
                  <input required className={inputCls} placeholder="+55 (61) 98765-4321"
                    value={msgForm.telefone} onChange={(e) => setMsgForm({ ...msgForm, telefone: e.target.value })} />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[#364153] text-[14px]" style={{ ...montserrat, fontWeight: 500 }}>Breve descrição do caso *</label>
                  <textarea required rows={4}
                    className="w-full bg-white rounded-[10px] border border-[#d1d5dc] px-4 py-3 text-[16px] text-[#121212] placeholder-[rgba(10,10,10,0.4)] outline-none focus:border-[#c5a059] focus:ring-1 focus:ring-[#c5a059] transition resize-none"
                    placeholder="Explique de forma breve sua demanda/caso."
                    value={msgForm.mensagem} onChange={(e) => setMsgForm({ ...msgForm, mensagem: e.target.value })} />
                </div>
                <button type="submit"
          ...
          <div>
            ...
            <div className="flex flex-col gap-5 mb-8">
              {[
                { Icon: Phone, label: "Dr. Gabriel Barcelos", value: "+55 (61) 98190-0501",  href: "tel:+556198190-0501" },
                { Icon: Phone, label: "Dr. Lucas Takaki",     value: "+55 (61) 98226-5931",  href: "tel:+556198226-5931" },
                { Icon: Mail,  label: "E-mail geral",         value: "contato@barcelostakaki.adv.br", href: "mailto:contato@barcelostakaki.adv.br" },
                { Icon: MapPin,label: "Endereço",             value: "Brasília, DF — Atendimento também por videoconferência", href: "#" },
              ].map((c) => {
                const Icon = c.Icon;
                return (
                  <a key={c.label} href={c.href}
                    ...
                    <div>
                      <p className="text-[#6a7282] text-[12px] mb-0.5" style={montserrat}>{c.label}</p>
                      <p className="text-[#1b2539] text-[15px] group-hover:text-[#c5a059] transition-colors" style={{ ...montserrat, fontWeight: 500 }}>
                        {c.value}
                      </p>
                    </div>
                  </a>
            ...
            <div
              ...
              style={{ background: "linear-gradient(128.66deg, #121212 0%, #1a1a1a 55%, #2a2a2a 100%)" }}
            >
              <div className="flex flex-col items-center gap-3">
                <img src={imgLogo} alt="Logo" className="h-16 w-auto object-contain opacity-80" />
                <p className="text-[#c5a059] text-[13px]" style={montserrat}>Barcelos &amp; Takaki Advocacia</p>
                <p className="text-[#f5f5f5] text-[12px] opacity-50" style={montserrat}>Brasília, DF</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="text-[#f5f5f5] text-[16px]" style={{ ...montserrat, fontWeight: 600 }}>Barcelos &amp; Takaki</p>
                <p className="text-[#c5a059] text-[12px]" style={montserrat}>Advocacia</p>
              </div>
            </div>
            <p className="text-[#6a7282] text-[14px] leading-relaxed" style={montserrat}>
              Escritório especializado em direito estratégico, comprometido com resultados éticos e eficientes para cada cliente.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="text-[#f5f5f5] text-[16px] mb-4" style={{ ...montserrat, fontWeight: 500 }}>Navegação</h4>
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={label}>
                  {href.startsWith("/") ? (
                    <Link to={href} className="text-[#6a7282] text-[14px] hover:text-[#c5a059] transition-colors" style={montserrat}>
                      {label}
                    </Link>
                  ) : (
                    <a href={href} className="text-[#6a7282] text-[14px] hover:text-[#c5a059] transition-colors" style={montserrat}>
                      {label}
                    </a>
                  )}
                </li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-[#f5f5f5] text-[16px] mb-4" style={{ ...montserrat, fontWeight: 500 }}>Contato</h4>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2 text-[#6a7282] text-[14px]" style={montserrat}>
                <Phone className="w-4 h-4 text-[#c5a059] flex-shrink-0" />(61) 98190-0501
              </div>
              <div className="flex items-center gap-2 text-[#6a7282] text-[14px]" style={montserrat}>
                <Phone className="w-4 h-4 text-[#c5a059] flex-shrink-0" />(61) 98226-5931
              </div>
              <div className="flex items-center gap-2 text-[#6a7282] text-[14px]" style={montserrat}>
                <MapPin className="w-4 h-4 text-[#c5a059] flex-shrink-0" />Brasília, DF
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[rgba(255,255,255,0.08)] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-5">
            {["Política de Privacidade", "Termos de Uso"].map((l) => (
              <a key={l} href="#" className="text-[#4a5565] text-[12px] hover:text-[#c5a059] transition-colors" style={montserrat}>{l}</a>
            ))}
          </div>
        </div>
      </div>

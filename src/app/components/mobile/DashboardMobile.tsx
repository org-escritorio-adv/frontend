...
import { Star, Clock, TrendingUp, ChevronRight, AlertTriangle, Calendar, Briefcase } from "lucide-react";
...
export function DashboardMobile() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* ── Hero: Greeting + Stats ───────────────────── */}
      <div className="bg-[#1A2B3C] text-white px-4 pt-6 pb-8 rounded-b-[32px]"
      ...
      <div className="mt-6 px-4 mb-4">
        <h2 className="text-base font-semibold text-[#1A2B3C] mb-3">
          Atividade Recente
        </h2>
            ...
            return (
              ...
              >
                <div className="flex gap-3 items-start">
                  {/* Icon */}
                  <div className={`w-10 h-10 rounded-xl ${activity.accent} flex items-center justify-center flex-shrink-0`}>

...
export function MeusCasos() {
  ...
  const cases = {
    ativos: [
      { id: "1", number: "0001234-56.2024.8.26.0100", client: "João da Silva",    status: "Em Andamento", statusColor: "bg-blue-500",   type: "Cível",       lastUpdate: "2 dias atrás", isFavorite: true  },
      { id: "2", number: "0007890-12.2024.8.26.0200", client: "Maria Oliveira",   status: "Aguardando",   statusColor: "bg-yellow-500", type: "Trabalhista", lastUpdate: "5 dias atrás", isFavorite: true  },
      { id: "4", number: "0009876-54.2024.8.26.0400", client: "Pedro Santos",     status: "Em Andamento", statusColor: "bg-blue-500",   type: "Trabalhista", lastUpdate: "1 dia atrás",  isFavorite: false },
    ] as CaseItem[],
    finalizados: [
      { id: "3", number: "0005678-90.2024.8.26.0300", client: "Empresa XYZ Ltda", status: "Finalizado",   statusColor: "bg-green-500",  type: "Empresarial", lastUpdate: "1 semana atrás", isFavorite: true },
    ] as CaseItem[],
  };
  ...
  const renderCard = (c: CaseItem) => (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <Badge className={`${c.statusColor} text-white border-0 text-xs`}>
          {c.status}
        </Badge>
        <button

import { LayoutDashboard, Briefcase, Search, Building2, Settings, Columns3, Users } from 'lucide-react';
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Tooltip */}
              <div className="absolute left-full ml-3 px-3 py-1.5 bg-[#0F1C29] text-white text-xs rounded-lg

      ...
      >
        ...
        <div className="flex items-start justify-between px-6 pt-6 pb-5 border-b border-gray-100">
          <div className="flex-1 min-w-0 pr-3">
            ...
            <div className="mt-2">
              <span
                className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border ${statusCfg.badge}`}
              >
                <span
                  className={`w-1.5 h-1.5 rounded-full ${statusCfg.dot} ${caso.status === 'ativo' ? 'animate-pulse' : ''}`}
                />
                {statusCfg.label}
              </span>
            </div>

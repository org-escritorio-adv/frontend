...
const processosData: Processo[] = [
  ...
  },
  {
    ...
    casoVinculado: 'Assessoria Jurídica em Licitação Pública – Pregão 05/2024'
  },
  {
    id: 'p4',
...
const totalArquivados = processosData.filter(p => p.status === 'Arquivado').length
const totalRecurso = processosData.filter(p => p.status === 'Em Recurso').length
      ...
      <div className="space-y-3">
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 gap-3 bg-white rounded-xl border border-gray-100">
            ...
            <p className="text-slate-500 text-sm">Nenhum processo encontrado para "{query}"</p>
